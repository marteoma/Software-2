                    ...
                    <div class="panel panel-primary">
                        ...
                        <form:form method="post" commandName="Mensajero">                      
                            <p>
                                ...
                                <form:input path="cedula" cssClass="form-control" required="required"  title="Solo números ,Tamaño máximo: 50 caracteres"></form:input>
                                </p>
                                <p>
                                <form:label path="telefono">Teléfono</form:label>
                                <form:input path="telefono" cssClass="form-control" required="required"  title="Solo letras ,Tamaño máximo: 50 caracteres"></form:input>
                                </p>
