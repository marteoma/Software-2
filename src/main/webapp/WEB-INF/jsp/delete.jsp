          ...
          <div class="panel panel-primary">
              ...
              <div class="panel-body">
                  ...
                  <form:form method="post" commandName="Pedido">
                      ...
                      <form:label path="contenido" cssClass="form-control"></form:input>
                      </p>
                      
                      <p>
                      <form:label path="estado">Estado</form:label>
                      <form:label path="estado" cssClass="form-control"></form:input>
                      </p>
                      <p>
                      <form:label path="mensajero">Mensajero</form:label>
                      <form:label path="mensajero" cssClass="form-control"></form:input>
                      </p>
                      
                      <p>
                      <form:label path="cliente">Cliente</form:label>
                      <form:label path="cliente" cssClass="form-control"></form:input>
                      </p>
